...
<head>
  <title>@yield('title', 'Vyora - Fashion Store')</title>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="Vyora Fashion Store - Temukan koleksi pakaian terkini dan belanja mudah via WhatsApp.">
    ...
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-md-4">
          ...
          <p class="text-muted mb-1"><i class="fa-solid fa-envelope me-2"></i> Email: info@vyorastore.com</p>
          <p class="text-muted"><i class="fa-solid fa-location-dot me-2"></i> Jakarta, Indonesia</p>
        </div>
      </div>
